    ...
    <div className={styles.container}>
      <header className={styles.header}>
        ...
        <div className={styles.roleToggle}>
          <button className={`${styles.toggleBtn} ${role === 'farmer' ? styles.active : ''}`} onClick={() => setRole('farmer')}>Farmer Mode</button>
          <button className={`${styles.toggleBtn} ${role === 'buyer' ? styles.active : ''}`} onClick={() => setRole('buyer')}>Buyer Mode</button>
        </div>
      </header>
